function [test_interactions, testinteractions_scores, indigo_model, sigma_delta_scores]  = indigo_predict_tb(indigo_model,testdata, input_type,annotation_filename,chemogenomics_filename,z,phenotype_data, phenotype_labels, conditions)
...
[testinteractions_scores, indigo_model, sigma_delta_scores]  = indigo_rf_3_tb_ensemble([],[], [], [], testdrugs,testchemgen, test_interactions,2,indigo_model);
