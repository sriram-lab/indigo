function [test_interactions, testinteractions_scores, indigo_model, sigma_delta_scores, conditions]  = indigo_predict(indigo_model,testdata, input_type,annotation_filename,chemogenomics_filename,z,phenotype_data, phenotype_labels, conditions)
