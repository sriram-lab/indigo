function [test_interactions, testinteractions_scores, ...
    ...
    indigo_predict(indigo_model, testdata, input_type, ...
    ...
    REQUIRED INPUTS: 
        1. indigo_model:            trained INDIGO model
    ...
    OUTPUTS:
        ...
        2. testxnscores:        interaction scores corresponding to 
                                train_interactions
        3. indigo_model:        trained INDIGO model 
    ...
    % For preserving trailing whitespace
    ...
    [testinteractions_scores, indigo_model, sigma_delta_scores] = ...
        indigo_rf([], [], [], [], testdrugs, testchemgen, ...
